...
if($projectType == "parent") {
	$parentProject = $module->createOrWipeTestProject("test_project_1","Cross Project Piping Test - Parent Project");
	...
	$pipingProject = $module->createOrWipeTestProject('test_project_2',"Cross Project Piping Test - Receiving Project");
